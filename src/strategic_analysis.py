...
class StrategicAnalyzer:
    ...
    def analyze(self):
        ...
        logger.info("Analyzing problem themes...")
                    ...
                    for theme, keywords in problem_themes.items():
                        for keyword in keywords:
                            if re.search(r'\b' + re.escape(keyword) + r'\b', response, re.IGNORECASE):
                                ...
                                break
        logger.info("Problem theme analysis complete.")
        ...
        logger.info("Categorizing problems...")
        ...
        logger.info("Problem categorization complete.")

        highest_impact_category = df_categories.iloc[0]

        output_file = os.path.join(self.output_dir, 'strategic_analysis_output.txt')
        logger.info(f"Saving strategic analysis to {output_file}...")
        ...
        logger.info(f"Análise estratégica salva em {output_file}")
